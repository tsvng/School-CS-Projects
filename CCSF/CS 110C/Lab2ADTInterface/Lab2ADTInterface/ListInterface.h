...
public:
	...
	/** Sees whether list is in ascending order.
	@return True is the list is in ascending sorted order; otherwise returns false. */
	virtual bool isInAscendingOrder() const= 0;
};
#endif
