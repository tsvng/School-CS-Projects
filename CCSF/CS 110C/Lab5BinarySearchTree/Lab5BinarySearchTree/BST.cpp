...
void BinarySearchTree::printTree(TreeNode *& nodePtr, int indentation)
{
	if (nodePtr != NULL)
	{
		printTree(nodePtr->rightChildPtr, indentation + 1);
		printTree(root, indentation);
		printTree(nodePtr->leftChildPtr, indentation + 1);
	}
